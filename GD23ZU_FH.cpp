...
#if (SizeFT813==38)
// GD.wr32(REG_TOUCH_CONFIG, 0x000005D1);
// GD.wr16(REG_TOUCH_OVERSAMPLE, 0x0f); 
// GD.wr16(REG_TOUCH_CONFIG, 0x05D0); //PROGRAMMER GUIDE: 0X5D   aLEMAN:0x05D0
// GD.wr16(REG_GPIOX_DIR,0x8008); 
// delay(1); 
// GD.wr16(REG_CPURESET, 0x00); 
// delay(56);
// GD.wr16(REG_GPIOX_DIR,0x8000); 
 //GD.wr16(REG_TOUCH_MODE, EVE_TMODE_CONTINUOUS);
#endif
...
//     #if(STM32_CPU == 767)
//      SD.begin(SD_PIN, SD_SCK_MHZ(36));      // STM32
      //SPI_3.beginTransaction(SD_PIN, SPISettings(36000000, MSBFIRST, SPI_MODE0));
//     #endif

//     #if(STM32_CPU == 7670)
//      SD.begin(SD_PIN, SD_SCK_MHZ(48));      // STM32
//     #endif
...
{
  #if(STM32_CPU == 7670)
    SPI_3.beginTransaction(SD_PIN, SPISettings(21000000, MSBFIRST, SPI_MODE0));
  #endif
