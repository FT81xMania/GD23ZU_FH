...
//#if (SizeFT813==52)
    ...
    digitalWrite(POR_PIN, HIGH);    // Pantalla FT81x comparada
...
//#endif
    ...
    SPI.begin();
      SPI.beginTransaction(SPISettings(47000000, MSBFIRST, SPI_MODE0));
...
//#if defined(TEENSYDUINO) || defined(ARDUINO_ARCH_STM32)
...
//#endif
  ...
  uint16_t begin1() {
    ...
    // model       0            1
    uint16_t __model = __rd16(0x0c0000UL);  
