...
void setup() {
   ...
   ClaveBoard=0;
     ...
     ClaveBoard=1;
     if(STM32_CPU==7670){
                        sprintf(Board, "MCU: STM32 Nucleo-F767ZI (Official Core-STM32)");
                       }
     if(STM32_CPU==767){
                        sprintf(Board, "MCU: STM32 Nucleo-F767ZI");
                       }
     if(STM32_CPU==746){
                        sprintf(Board, "MCU: STM32 Core7XXI");
                       }
     if(STM32_CPU==4071){
                        sprintf(Board, "MCU: STM32F4/F7 with SDIO card");
                       }                       
     if(STM32_CPU==429){
                        sprintf(Board, "MCU: STM32 F429I-DISCO");
                       }
     if(STM32_CPU==407){
                        sprintf(Board, "MCU: STM32 M4DEMO");
                       }                       
  #endif
  ...
  #if !defined(ARDUINO_ARCH_STM32)&& !defined(TEENSYDUINO)&& !defined(ESP32)&& !defined(__DUE__)&& !defined(ESP8266)&& defined(ARDUINO)
     ClaveBoard=6;
