...
int SalirdeMP, DespXMP=-500;   //MP       480x272 px
...
void MP()
{
  ...
  while(1)
  {
   ...
   GD.SaveContext();
    ...
    if(SalirdeMP==1){DespXMP=DespXMP-VelDespX; if(DespXMP<=-700){SalirdeMP=0; DespX=-390; M1();}}
    if(SalirdeMP==2){DespXMP=DespXMP-VelDespX; if(DespXMP<=-700){SalirdeMP=0; DespX=-850; M2();}}
...
void M1()
{
  ...
  while(1)
  {
   ...
   GD.SaveContext();
    ...
    if(SaliraMP==2){DespX=DespX-VelDespX; if(DespX<=-400){SaliraMP=0;  DespX=-850; M2();}}
    if(SaliraMP==1){DespX=DespX-VelDespX; if(DespX<=-400){SaliraMP=0; MP();}}
...
void M2()
{
  ...
  while(1)
  {
   ...
   GD.SaveContext();
    ...
    if(SaliraMP==2){DespX=DespX-VelDespX; if(DespX<=-845){SaliraMP=0; DespX=-390; M1();}}
    if(SaliraMP==1){DespX=DespX-VelDespX; if(DespX<=-845){SaliraMP=0; MP();}}
    if(SaliraMP==0){DespX=DespX+VelDespX; if(DespX>=0){DespX=0;}}
   GD.RestoreContext();
