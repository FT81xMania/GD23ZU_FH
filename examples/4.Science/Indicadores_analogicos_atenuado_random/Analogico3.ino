// Solo aguja analogica vertical 90 a 270 grados
void Analogico3(uint16_t RadioBase, uint16_t XBase, uint16_t YBase, uint16_t LargoAguja, uint16_t Addaguja, uint16_t EspesorAguja, uint16_t Variable, uint16_t RangoEscala, uint16_t SizeTxt, uint16_t XTxt, uint16_t YTxt, uint16_t pivote)
{
...
//         Tetha = (200 * Variable/RangoEscala);
          ...
          Tetha = map(Variable, 0, RangoEscala, 60, 280);       //elimina el limite horizontal de los 180 grados XD  
