...
void loop2()
{
  //circular(0, 0, 180, 100, 0x772b55, 0xef8619);
  //GD.cmd_text(400, 50, 31, OPT_CENTER, "Hello world");
  //circular(0, 0, GD.w, GD.h, 0x772b55, 0xef8619);
  //circular(0, 0, GD.w, GD.h, 0x000000, 0x000030);
  circular(0, 0, GD.w, GD.h, 0x000000, 0x400000);
  ...
  GD.Vertex2ii(0, 0, 10);
  GD.Vertex2ii(0, 0, 11);
  GD.Vertex2ii(50, 100, 12);
  GD.Vertex2ii(100, 200, 13);
  GD.RestoreContext();
