 ...
 */
const uint8_t SD_CHIP_SELECT = PB11;  //SPI3 on Nucleo F767ZI
/*
...
//SdFat sd;
 ...
 SPIClass SPI_x(PB2, PB4, PB3);      //SPI3 on Nucleo F767ZI/H743ZI
 SdFat sd(&SPI_x);                   //SPI3 on Nucleo F767ZI/H743ZI
...
if (Test==1)  
{
  ...
  GD.RestoreContext();
   ...
   GD.ColorRGB(0x00ff00);  GD.cmd_number(130, 5, 18, 0, SD_FAT_VERSION);
   
   GD.ColorRGB(0xffffff);  GD.cmd_text(10, 20, 18, 0, "SD card is present.");

   sprintf(LoadTime, "Chip select pin: %d, Card size(MB): ", SD_CHIP_SELECT);  
   GD.ColorRGB(0xff,0xff,0x00);   GD.cmd_text(10, 35, 18, 0, LoadTime);  GD.cmd_number(255+25+35, 43, 18, OPT_CENTER, 0.000512*cardSize);
